...
def page_activiteiten():
    ...
    if current_role() == "admin":
        ...
        if df_del.empty: st.caption("Geen toekomstige activiteiten.")
            ...
            with t2:
                edit_clicked = st.button("bewerken", key="act_hdr_edit")
            with t3:
                del_clicked = st.button("verwijderen", key="act_hdr_del")
            ...
            if 'mg__last_act_id' not in st.session_state or st.session_state.get('mg__last_act_id') != _act_id:
                try:

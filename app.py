...
def page_activiteiten():
    ...
    if current_role() == "admin":
        ...
        if df_del.empty: st.caption("Geen toekomstige activiteiten.")
            ...
            # Titelbalk met knoppen in één rij
            ...
            # Als selectie wijzigt tijdens bewerken, editor sluiten
            ...
            # Editor tonen zolang bewerkmodus actief is
            if st.session_state.get("mg_edit_mode") and st.session_state.get("mg_edit_id") == _act_id:
                # haal huidige rij
                _row = None
                try:

            ...
            with st.expander(f"{titel}   ·   {badge}", expanded=False):
                ...
                try:
                    ...
                    with pd.ExcelWriter(_out, engine="openpyxl") as _w:
                        ...
                        # Verwijder username-kolom uit export (expliciet)
                        ...
                        try:
                            ...
                            if isinstance(_part_df, pd.DataFrame) and "username" in _part_df.columns:


            

                                _part_df = _part_df.drop(columns=["username"])
